...
local default_options = {
  ...
  laststatus = 2,            --The value of this option influences when the last window will have a status line (2: always)
  showtabline = 1,           --	The value of this option specifies when the line with tab page labels will be displayed (1: only if there are at least two tab pages)
